...
3.  Determine the probability (the *p*-value) of getting our experimental data, or data more extreme, if $H_0$ is true.
...
ggplot(data = data.frame(mass = c(mu - 3 * sd, mu + 3 * sd)),
  ...
  annotate("text", size = 5,
           x = 1800, y = 0.00055,
           label = "Distribution of the values") +
  annotate("segment",
           x = 1800, y = 0.0005,
...
#| fig-cap: "The sampling distribution of the means tells us the probability of getting our sample mean or a sample mean more extreme."
