...
One of the differences uses most notice between Windows and Mac machine is the keyboard keys names. Table @tab-key-board gives some of the most notable.
...
: Keyboard equivalents for Windows and Mac {#tab-key-board}
