...
distribution is, the standard deviation determines the spread. @fig-normal-same-mean The distributions have the same mean but 
...
::: {#fig-norm-dist-properties layout-ncol="1"}
```{r}
#| echo: false
