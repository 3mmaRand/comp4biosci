# Molecular weight from SDS-PAGE.qmd {#mol-wt-sds-page}
...
of results (one each side) - since only 4 lanes were for each
...
[standard-mw.txt](data-image/standard-mw.txt) to `data-raw`.
