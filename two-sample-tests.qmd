...
*t* = `r t_value`;
*d.f.* = `r df_residuals`; *p* = `r cana_m`). See @fig-chaff.
...
chaffinches were significantly heavier than Coelebs (*t* = `r coel_se`;
*d.f.* = `r df_residuals`; *p* = `r t_value`). Data analysis was conducted 
