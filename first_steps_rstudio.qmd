...
**A screenshot of RStudio showing the `people` dataframe over the script on the 
left and the Environment pane on the right** To open a spreadsheet-like view of 
...
## Summary of First Steps in R and RStudio
