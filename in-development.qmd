# In development {#sec-in-development}
...
## qPCR working with step one files

<!-- df <- data.frame(x = c(0, 0.01, 0.1, 1), -->
<!--                  y = c(0.56, 0.475, 0.4, 0.375)) -->

<!-- df <- df |>  -->
<!--   mutate(log_x = log(x + 0.000001)) -->

<!-- ggplot(data = df, aes(x = log_x, y = y)) + -->
<!--   geom_point() + -->
