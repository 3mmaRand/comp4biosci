...
an equation that maps shows what has to be done to the explanatoruy values to get the response value. For example, if a plant grows by 2 cm a day week after it is two weeks old
