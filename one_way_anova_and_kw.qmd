...
#| fig-cap: "The diamters of bacterial colonies when gron in one of three media. A violin plot is a useful way to get an overview of the data and helps us identify any issues such as missing or extreme values. It also tells us what to expect from the analysis."
#| 
ggplot(data = culture,
...
-   `(Intercept)` which is the mean of the control group
...
-   `mediumsugar added` is what needs to be added to the mean of the
...
-   `mediumsugar and amino acids added` is what needs to be added to the
...
-   `(Intercept)                     10.0700     0.2930  34.370  < 2e-16 ***`
    ...
    zero. This is not a very interesting, it just means there control
